...
% LC: there isn't any transition from talking about Kepler-76 b to the TESS Mission at the end of the abstract. - BJ
...
% LC: there's no explanation for Section 3.
...
$A_{\rm planet}$ (ppm) & $50.4 \pm 1.3$ & Phase Curve Amplitude\\
...
% LC: Here, above, the term is written as "Markov Chain Monte Carlo", while in Faigler et al. 2013 the term is written as "Markov chain Monte Carlo" without hyphens or a reference. - BJ
...
% LC: Below, in the 3rd sentence which begins with 'Figure 3 shows..", you have the phrase "where c the speed of light".  Choose either "where c is the speed of light" OR "with c the speed of light". - BJ
...
% LC: In the next paragraph, the expression for MCMC is spelled out; yet, this expression has already been spelled out in paragraph 2 of this section 2.2.1.  Between there and below, the acronym MCMC has been utilized. ? - BJ
% LC: Also, the entire sentence is a smidge awkward; in phrase "by also fitting transit curves", to what is the 'also' referring? The previous sentence does include "fit ... transit ... using LM".  Perhaps this sentence would work: 
%  "For uncertainties, and using an MCMC analysis, we took the sq root of ... mid-transit times and uncertainties to several individuals transits - we achieved convergence with ... 300 links." - BJ
...
% LC: In the caption below for Fig 6, there's a lovely description of the histograms. So, why isn't there a similar explanation on Fig.s 3 and 4? - BJ: Moved histogram description to Figure 3.
\begin{figure}
...
% LC: In the paragraph above, are we/you sure you want to write, "with a KS probability of a few 0.1%" ?  Wouldn't it read better to have, "with a KS probability of 0.1%" ? - BJ
% LC: Also, and this is important, I changed the punctuation in the last sentence to make two sentences. By having "This trend is not surprising." as a short, simple sentence gives it more impact. - BJ
...
% From Parmentier+ (2016) - Recent observations show that the Kepler light curves of some hot Jupiters are asymmetric: for the hottest planets, the light curve peaks before secondary eclipse, whereas for planets cooler than ∼1900 K, it peaks after secondary eclipse.
...
% LC: In the original first sentence of this paragraph, the verb was buried 28 words in. - BJ: Improved transition
...
% LC: Below, you have the "median value of -81 degrees +- 0.4 degrees" in relation to phase curve.  But in the Abstract, you use the term "averaging" and place the value in ( ), "(8.6 +- 1.3) degrees". So, did you use the ( ) to denote the negative or eastward-ness?  Why report the average in the Abstract and the median below? - BJ: Fixed abstract to make it agree with the discussion here
...
% LC: Perhaps paragraphs 1-4 above could be a subsection, e.g., 3.1 Comparative Analysis? The 4th paragraph does start with "Finally,".  Then, there could be a subsection 3.2 just before this paragraph, in which there's a shift in the discussion away from the comparison with Faigler ? - BJ: Good suggestion. I've broken up this last section into a Results section and a Conclusions section.
...
% From Parmentier+ (2016) - "We predict that a change from a reflected to a thermal dominated light curve should occur at an equilibrium temperature of ∼1900 K, naturally explaining the trend from negative to positive offset in the Kepler data."
...
\begin{figure}
\includegraphics[width=\textwidth]{Aplanet-delta-var_Analysis_of_Kepler76b.png}
